  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div
          v-else
          class="text-2xl text-black flex flex-col gap-y-4 items-center justify-center h-full w-full pb-8"
        >
          <h1 class="font-medium text-5xl">
            Photography - David Barringer
          </h1>
          <p class="text-gray-400">
            A collection of photos taken on my Sony Alpha 7 III
          </p>
        </div>
